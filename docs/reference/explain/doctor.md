  ...
  "definitions": {
    ...
    "ProvenanceKind": {
      ...
      "oneOf": [
        ...
        {
          "description": "The manifest key disagrees with `placement(entry.url)` — the path the entry's own URL derives to under the canonical layout. Warning severity; report-only.\n\nExempt by role rather than by survey: `reference` entries may point at a mirror on purpose (the same exemption `OriginUrlMismatch` already carries), and `fork` entries may key on the upstream's coordinates while the URL names the fork (`docs/reference/roles.md` §`fork`, \"The path may name either\"). Neither role reaches this variant at all — the scan skips them before deriving `expected_path`.",
          "type": "object",
          "required": [
          ...
          "properties": {
            "placement-disagreement": {
              ...
              "properties": {
                "expected_path": {
                  "description": "The path `placement(entry.url)` derives — where the manifest key would need to be for the two to agree.",
                  "type": "string"
                }
              }
            }
    ...
    "ViolationOutput": {
      ...
      "oneOf": [
        ...
        {
          "description": "See `CheckViolation::ConfusableSiblings`.",
          "type": "object",
          "required": [
            "first",
            "kind",
          ...
          "properties": {
            "first": {
              "description": "The two spellings, in a stable order.",
              "type": "string"
            },
            "kind": {
              "type": "string",
            ...
            "parent": {
              "description": "The namespace the two names share.",
              "type": "string"
            },
            "second": {
              "type": "string"
    ...
    "WorkweaveTreeIntegrityKind": {
      ...
      "oneOf": [
        ...
        {
          "description": "A `.rwv-workweave` marker that parses as neither current JSON nor a `migrate_legacy`-repairable legacy shape — YAML with no `primary:` for `migrate_legacy` to backfill from, or no valid `project:` for it to construct from. Every marker rwv has ever written carries all three fields, so this is hand-corruption or a truncated write rather than a shape upgrading produces. Report-only: there is no value here to guess a repair from.",
          "type": "object",
          "required": [
            "unreadable-marker"
          ],
          ...
          "properties": {
            "misnamed-dir": {
              ...
              "properties": {
                ...
                "expected_dir_name": {
                  "description": "The basename the records expect (`{project}--{name}`), when the records pin one. `None` when no registry entry names this path and the basename is not one the marker's project renders.",
                  "type": [
                    "string",
                    "null"
                  ]
