...
- [Switch projects](./how-to/switch-projects.md)
- [Add a repo](./how-to/add-a-repo.md)
- [Run a command across repos](./how-to/run-a-command-across-repos.md)
...
- [Plugin boundary](./explanation/joints/plugin-boundary.md)
...
- [Integrations](./reference/integrations/index.md)
  - [npm-workspaces](./reference/integrations/npm-workspaces.md)
  - [pnpm-workspaces](./reference/integrations/pnpm-workspaces.md)
  - [go-work](./reference/integrations/go-work.md)
  - [uv-workspace](./reference/integrations/uv-workspace.md)
  - [cargo-workspace](./reference/integrations/cargo-workspace.md)
  - [gita](./reference/integrations/gita.md)
  - [vscode-workspace](./reference/integrations/vscode-workspace.md)
  - [static-files](./reference/integrations/static-files.md)
